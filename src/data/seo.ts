...
export const seoConfig: Record<string, PageSEO> = {
  ...
  '/dress-materials': {
    url: '/dress-materials',
    title: 'Unstitched Dress Materials Shop in Thane | Cotton, Silk & Fancy Suits',
    description: 'Explore exquisite unstitched dress materials in pure cotton, chanderi, georgette & silk at Sanjay Cut Piece Thane West. Premium quality suit pieces for all occasions.',
    primaryKeyword: 'dress materials in Thane',
    secondaryKeywords: ['unstitched dress material Thane', 'cotton dress material shop', 'chanderi dress material Thane'],
    longTailKeywords: ['cotton dress materials manufacturer supplier in Thane', 'unstitched suit piece shop near Jambli Naka'],
    searchIntent: 'Commercial / Product',
    h1: 'Unstitched Dress Materials in Thane',
    priority: 0.9,
    changefreq: 'weekly',
    schemaType: 'Product',
    breadcrumbs: [
